            ...
            <div>
                <Drawer width={200} open={true} containerStyle={this.navigationStyle}>
                    ...
                    <MenuItem
                        ...
                        label="Home"
                        active={this.props.location.pathname.includes('/home')}
                    />
                    <MenuItem
                        url="/aboutme/"
                        ...
                        label="About me"
                        active={this.props.location.pathname.includes('/aboutme')}
                    />
                    <MenuItem
                        url="/skills/"
                        icon="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"
                        label="Skills"
                        active={this.props.location.pathname.includes('/skills')}
                    />
                    <MenuItem
                        url="/experience/"
                        icon="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"
                        label="Experience"
                        active={this.props.location.pathname.includes('/experience')}
                    />
                    <MenuItem
                        url="/certificates/"
                        ...
                        label="Certificates"
                        active={this.props.location.pathname.includes('/certificates')}
                    />
                    {/*<MenuItem*/}
                        {/*url="/contact/"*/}
                        ...
                        {/*label="Contact"*/}
                        {/*active={this.props.location.pathname.includes('/contact')}*/}
                    {/*/>*/}
                </Drawer>
            </div>
        );
